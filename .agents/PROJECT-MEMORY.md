...
|---|---|---|---|---|
| Base (fork master) | `master` | `1a4f4412c3` (squash-merge of #21) | â€” | public |
...
| Runtime gating: `app-builder-shell` slot not declared in `packages/client/ui-layout/src/client/index.ts` children table â†’ new 2.5 panes runtime-dead | v0.1.2-alpha.1 merge | per-area 1.5.x follow-up | Documented in `2026-09-02-v0.1.2-alpha.1-app-builder-shell-children-regression.md` |
