/**
 * App Builder projects pane, node half. Pure UI plugin: the empty apply exists
...
/** Host plugin body — no host-side behavior; the projects pane renders entirely in the browser. */
