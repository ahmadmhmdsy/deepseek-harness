...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  {
    ...
    occupants: [
      'client-ui-app-builder-shell Shell',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'app-builder-shell\', () => ctx.slots.register(\n      { name: \'app-builder-shell\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-app-builder-shell/src/client/contract/slots.ts:20',
  },
  {
    key: 'app-builder.conversation',
    kind: 'single',
    scope: 'session',
    summary: 'Center pane: chat.',
    doc: 'Center pane: chat.',
    registerOptions: [],
    ownerProps: [
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'app-builder-shell\' (client-ui-app-builder-shell), so it exists while that entry is mounted',
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'app-builder.conversation\', () => ctx.slots.register(\n      { name: \'app-builder.conversation\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-app-builder-shell/src/client/contract/slots.ts:26',
  },
  {
    key: 'app-builder.preview',
    kind: 'single',
    scope: 'root',
    summary: 'Right pane: preview iframe.',
    doc: 'Right pane: preview iframe.',
    registerOptions: [],
    ownerProps: [
    ...
    source: 'packages/client/ui-app-builder-shell/src/client/contract/slots.ts:24',
  },
  {
    key: 'app-builder.projects',
    kind: 'single',
    scope: 'root',
    summary: 'Left pane: project list.',
    doc: 'Left pane: project list.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'app-builder-shell\' (client-ui-app-builder-shell), so it exists while that entry is mounted',
    occupants: [
      'client-ui-app-builder-projects ProjectsList',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'app-builder.projects\', () => ctx.slots.register(\n      { name: \'app-builder.projects\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-app-builder-shell/src/client/contract/slots.ts:22',
  },
  {
    key: 'conversation',
    kind: 'single',
