...
| [`app-builder/`](app-builder/README.md) | App Builder MVP: project entity, scaffold/preview tools, persona, over a `cordis.patch.yml` bundle layer | Product — stable API |
