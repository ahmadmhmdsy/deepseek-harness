...
| [app-builder.md](app-builder.md) | App Builder: project registry, preview snapshot bridge, and the Host BFF Typert Remote service; bundles under `packages/bundle/app-builder` |
